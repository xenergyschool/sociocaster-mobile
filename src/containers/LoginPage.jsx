...
class LoginPage extends Component {
    ...
    openForgotPasswordPage(e) {
        const {navigator} = this.props
        navigator.pushPage({ component: ForgotPasswordPage, key: 'SIGNUP_PAGE' })
    }
    render() {
                ...
                <Page>
                    <div className='page-wrapper'>
                        <div className='page-inner'>
                            ...
                            <LoginForm handleClickLogin={this.handleClickLogin} openSignUpPage={this.openSignUpPage} openForgotPasswordPage={this.openForgotPasswordPage} handleChange={this.handleChange} username={this.state.username} password={this.state.password} />
                        </div>
                    </div>
